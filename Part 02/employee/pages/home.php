...
<div style="width:1000px; min-height:600px;">
   <div style="width:200px; min-height:600px; float:left; background-color:#0000CC;">
     <div style="width:196px; min-height:600px; margin:2px 2px 2px 2px;">
   ...
   <div style="width:800px; min-height:600px; float:left;">
     <div style="width:796px; min-height:600px; margin:2px 2px 2px 2px;">
