...
<div style="width:1000px; min-height:580px; background-color:#CCC;  background-image:url(../icon/wrap_mid_bg.png);">
   <div style="width:200px; min-height:400px; float:left;">
     <div style="width:196px; min-height:400px; margin:2px 2px 2px 2px;">
        <div style="margin-left:22px;">
            ...
            ?>
            <img style=" border:1px solid #FFF;" src="../../image/<?php echo $rows01[2];?>" height="150" width="150"/>
        </div>
        ...
        <div style="margin:0 0 0 5px;">
         ...
         <ul class="left_list">
           ...
           <li>
             <a href="masterview.php">View Resume</a>
           </li>
           
           <li>
             <a style="color:#D9D900;" href="ChangePassword.php">Change Password</a>
           </li>
   ...
   <div style="width:800px; min-height:580px; float:left; background-color:#FFFFFF;">
     <div style="width:796px; min-height:580px; margin:2px 2px 2px 2px;">
	   <?php
