...
<div><!--Page Area -->
 ...
 <div align="center" style="width:796px; min-height:158px; border-bottom:1px solid #000;">
 <div>
 
 <div style="width:796px; min-height:150px;">
 ...
 <div style="background:#C68C8C; height:32px;">
 <div style="float:left;">
 <h3 style="color:#00F; padding:3px 0 0 20px;">PERSONAL INFORMATION</h3>
 </div>
 <div style="float:right; padding:5px 10px 0 0;"">
 <a href="EditPersonalInformation.php"><img src="../icon/edit-notes.png" border="0" title="Edit"/></a>
 </div>
 <div style="clear:both;"></div>
 </div>
 
 <div style="min-height:200px; width:746px; margin:5px 0 0 50px;">
  <table><tbody>
  <tr>
 ...
 <div style="background:#C68C8C; height:32px;">
 <div style="float:left;">
 <h3 style="color:#00F; padding:3px 0 0 20px;">SCHOLASTIC STATUS</h3>
 </div>
 <div style="float:right; padding:5px 10px 0 0;"">
 <a href="EditScholasticStatus.php"><img src="../icon/edit-notes.png" border="0" title="Edit"/></a>
 </div>
 <div style="clear:both;"></div>
 </div>
 
 
        <div style="margin:10px 0 10px 10px; width:786px; min-height:150px;">
          ...
          <div style="width:776px; min-height:20px; color: #9F0000; margin:0 10px 0 10px; border-bottom:1px solid #333;">EXTRA CURRICULAM ACTIVITIES</div>
          <div style="margin:5px 0 10px 50px;  width:696pxpx; min-height:15px;">
          <?php echo $rows04[2];?>
          </div>
          
          <div style="width:776px; min-height:20px; color: #9F0000; margin:0 10px 0 10px; border-bottom:1px solid #333;">OTHER SKILLS &amp; INFORMATION</div>
          <div style="margin:5px 0 10px 50px; width:696px; min-height:15px;">
          <?php echo $rows04[3];?>
          </div>
         ...
         <div style="background:#C68C8C; height:32px;">
         <div style="float:left;">
         <h3 style="color:#00F; padding:3px 0 0 20px;">EXPERIENCE</h3>
         </div>
         <div style="float:right; padding:5px 10px 0 0;"">
          <a href="EditExperience.php"><img src="../icon/edit-notes.png" border="0" title="Edit"/></a>
         </div>
         <div style="clear:both;"></div>
         </div>
                  
        <div style="margin:10px 0 10px 10px; width:786px; min-height:200px;">
        <table width="100%"><tbody>
         ...
         <div style="background:#C68C8C; height:32px;">
         <div style="float:left;">
         <h3 style="color:#00F; padding:3px 0 0 20px;">REFERENCES</h3>
         </div>
         <div style="float:right; padding:5px 10px 0 0;"">
          <a href="EditReferences.php"><img src="../icon/edit-notes.png" border="0" title="Edit"/></a>
         </div>
         <div style="clear:both;"></div>
         </div>
